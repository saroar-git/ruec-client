  ...
  return (
    <>
      ...
      <div className='mb-24 mt-14 grid grid-cols-1 md:grid-cols-3 md:gap-10' >
        ...
        <div className='flex flex-col items-center gap-4' data-aos="fade-up" data-aos-easing="ease-out-cubic"
          data-aos-duration="1000">
        ...
        <div className='flex flex-col items-center gap-4 my-16 md:my-0' data-aos="fade-up" data-aos-easing="ease-out-cubic"
